...
import 'package:charts_flutter_web/src/graphics_factory.dart';
import 'package:charts_flutter_web/src/text_element.dart';
...
void main() {
  test('Text element gets assigned scale factor', () {
    ...
    final graphicsFactory =
         GraphicsFactory( MockContext(), helper: helper);
