...
* Added custom colors for line renderer area skirts and confidence intervals. A  "areaColorFn"
...
For example, previously to construct a bar chart the syntax was ' BarChart<MyDatumType>()'.
The syntax is now cleaned up to be ' BarChart()'. Please refer to the
