...
void main() {
  ...
  setUp(() {
    myFakeDesktopData = [
       ...
       MyRow('MyOtherCampaign', 4, 75, MaterialPalette.red.shadeDefault,
          null, 2.0),
    ];
  ...
  group('preprocess', () {
    ...
    test('with numeric data and repeats in style', () {
      var myFakeData = [
         MyRow(
            'MyCampaign1', 1, 5, MaterialPalette.blue.shadeDefault, null, 2.0),
         MyRow('MyCampaign2', 2, 25, MaterialPalette.green.shadeDefault,
            null, 2.0),
         MyRow('MyCampaign3', 3, 100, MaterialPalette.blue.shadeDefault,
            null, 2.0),
         MyRow('MyCampaign4', 4, 75, MaterialPalette.green.shadeDefault,
            null, 2.0),
         MyRow(
            'MyCampaign1', 5, 5, MaterialPalette.blue.shadeDefault, null, 2.0),
         MyRow('MyCampaign2', 6, 25, MaterialPalette.green.shadeDefault,
            null, 2.0),
         MyRow('MyCampaign3', 7, 100, MaterialPalette.blue.shadeDefault,
            null, 2.0),
         MyRow('MyCampaign4', 8, 75, MaterialPalette.green.shadeDefault,
            null, 2.0),
      ];
