...
abstract class CartesianChart<D> extends BaseChart<D> {
  ...
  /// and the  domain axis created when [domainAxisSpec] is set to a 
  /// spec.
  ///
  ...
  /// is available and [_DomainAxis] will be set to [_domainAxis] and then
  /// reset back to null.
  Axis<D> _DomainAxis;
  ...
  /// Temporarily stores the  domain axis spec that is passed in when
  /// [domainAxisSpec] is set and is different from [_domainAxisSpec]. This spec
  /// is then applied to the  domain axis when [configurationChanged] is
  /// called.
  AxisSpec<D> _DomainAxisSpec;
  ...
  CartesianChart(
      ...
      : vertical = vertical ?? true,
        // [domainAxis] will be set to the  axis in [configurationChanged].
  ...
  /// Create a  domain axis and save the  spec to be applied during
  /// [configurationChanged].
  set domainAxisSpec(AxisSpec axisSpec) {
    if (_domainAxisSpec != axisSpec) {
      _DomainAxis = createDomainAxisFromSpec(axisSpec);
      _DomainAxisSpec = axisSpec;
    }
  }
  ...
  void configurationChanged() {
    ...
    if (_DomainAxisSpec != null) {
      _domainAxisSpec = _DomainAxisSpec;
      _DomainAxisSpec.configure(_domainAxis, context, graphicsFactory);
      _DomainAxisSpec = null;
    }
  }
  ...
  // TODO: Change measure axis spec to create  measure axis.
